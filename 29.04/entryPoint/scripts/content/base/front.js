(function (e) {
  e.getAllImages = function () {
    chrome.runtime.getPackageDirectoryEntry(function (arg) {
      arg.getDirectory('entryPoint/static/pictures', {}, function (imgDir) {
        var dirReader = imgDir.createReader();
        var buffer = [];
        ...
        getEntries(function (entries) {
          e.imageBuffer = entries.map(function (el) {
            return {
  ...
  e.setNewTabBackground = function () {
    ...
    if (localStorage.getItem("shuffle_background") == "yes" || localStorage.getItem("shuffle_favorites") == "yes" && favorArr.length == 0) {
      ...
      chosenRandomBG = "bg-" + ("0" + lastBackground).slice(-2) + ".jpg";
    }
